...
<html lang="en">
  ...
  <div id="mainform">
    <div class="row">
        <div class="col-sm-6">
            <div id="formInsertar">
            <h1>AÑADIR EDITORIALES</h1>
                <form id="formulario" onsubmit="validarFormularioInsertar()">
                    ...
                    <input type="text" id="creador" name="creador" onchange="validarCreador()">
                    <div id='divErrores'>
                    </div>
                    <label for="genero">Género</label>
                    <input type="text" id="genero" name="genero" onchange="validarGenero()">
                    <div id='divErrores'>
                    </div>
                    <label for="precio">Precio</label>
                    <input type="text" id="precio" name="precio" onchange="validarPrecio()">
                    <div id='divErrores'>
                    </div>
                    <label for="editorial">Editorial</label>
                    <input type="text" id="editorial" name="editorial" onchange="validarEditorial()">
                    <div id='divErrores'>
                    </div>
