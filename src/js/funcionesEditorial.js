...
function validarDireccion() {
    let inputdireccion = $("#direccion").val();
    let Input = $("#direccion");
    $.ajax({
        url: "servidor/editorial/validarEditorialConn.php",
        data: { direccion: inputdireccion },
        method: "POST",
        dataType: "JSON",
        beforeSend: function () { $("#spinner").css("display", "block"); },
        success: function (text) {
...
function validacionFormularioInsertar() {
    ...
    $.ajax({
        url: "servidor/editorial/validarEditorialConn.php",
        data: { id: inputid.val(), nombre: inputnombre.val(), direccion: inputdireccion.val(), producto: inputemail.val() },
        method: "POST",
        dataType: "JSON",
        beforeSend: function () { $("#spinner").css("display", "block"); },
        success: function (text) {
            ...
            if (gestionarErrores(inputid, text.id) === false && gestionarErrores(inputnombre, text.nombre) === false && gestionarErrores(inputdireccion, text.direccion) === false &&
                gestionarErrores(inputemail, text.email) === false) {
                $.ajax({
                    url: "servidor/editorial/anadirEditorialConn.php",
                    data: { id: inputid.val(), nombre: inputnombre.val(), direccion: inputdireccion.val(), email: inputemail.val() },
                    method: "POST",
                    dataType: "JSON",
                });
