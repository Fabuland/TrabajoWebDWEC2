...
function validarCreador() {
    let inputcreador = $("#creador").val();
    let Input = $("#creador");
    $.ajax({
        url: "servidor/juegos/validarJuegosConn.php",
        data: { creador: inputcreador },
        method: "POST",
        dataType: "JSON",
        beforeSend: function () { $("#spinner").css("display", "block"); },
        success: function (text) {
...
function validarEditorial() {
    let inputeditorial = $("#editorial").val();
    let Input = $("#editorial");
    $.ajax({
        url: "servidor/juegos/validarJuegosConn.php",
        data: { editorial: inputeditorial },
        method: "POST",
        dataType: "JSON",
        beforeSend: function () { $("#spinner").css("display", "block"); },
        success: function (text) {
...
function validacionFormularioInsertar() {
    ...
    let inputcreador = $("#creador");
    let inputprecio = $("#precio");
    let inputgenero = $("#genero");
    let inputeditorial = $("#editorial");
    
    $.ajax({
        url: "servidor/juegos/validarJuegosConn.php",
        data: { id: inputid.val(), nombre: inputnombre.val(), creador: inputcreador.val(), precio: inputprecio.val(), genero: inputgenero.val(), editorial: inputeditorial.val()   },
        method: "POST",
        dataType: "JSON",
        beforeSend: function () { $("#spinner").css("display", "block"); },
        success: function (text) {
            ...
            if (gestionarErrores(inputid, text.id) === false && gestionarErrores(inputnombre, text.nombre) === false && gestionarErrores(inputcreador, text.creador) === false &&
                gestionarErrores(inputprecio, text.precio) === false &&
                gestionarErrores(inputgenero, text.genero) === false &&
                gestionarErrores(inputeditorial, text.editorial) === false) {
                $.ajax({
                    url: "servidor/juegos/anadirJuegosConn.php",
                    data: { id: inputid.val(), nombre: inputnombre.val(), creador: inputcreador.val(), genero: inputgenero.val(), precio: inputprecio.val(), editorial: inputeditorial.val() },
                    method: "POST",
                    dataType: "JSON",
                });
